...
3. 📈 **Determinar el estado del estudiante**
4. 🔄 **Permitir registrar varios estudiantes usando un menú**
5. 📋 **Mostrar un resumen final**

---

## 📐 Reglas del Sistema

### Datos de entrada para cada estudiante:
- **Nombre**
- **Edad**
- **Nota 1**
- **Nota 2**
...
### Estado académico según promedio:
...
## 🏗️ Estructura Obligatoria del Programa
...
- ✔️ **Que las notas estén entre 0 y 5**
- ✔️ **Que la edad sea mayor que 0**
